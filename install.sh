...
echo "
+----------------------------------------------------------------------
| Bt-Panel 5.x FOR CentOS/Redhat/Fedora/Ubuntu/Debian(unofficial)
+----------------------------------------------------------------------
| Copyright © 2015-2017 Bt-Panel All rights reserved.
+----------------------------------------------------------------------
...
github_Url=https://github.com/OSI-LTD/bt-panel
github_Tag=5.4.1
