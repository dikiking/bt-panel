var lan = {
	...
	"site":{
		...
		"ssl_crt":"证书(CRT/PEM)",
		"ssl_close":"关闭SSL",
		"bt_bind_no":"未绑定官方账号，请注册绑定，绑定账号(非论坛账号)可实现一键部署SSL",
		"bt_user":"账号",
		"login":"登录",
		"bt_reg":"注册账号",
		"bt_ssl_help_1":"免费SSL证书为亚洲诚信证书，需要实名认证才能申请使用",
		"bt_ssl_help_2":"已有账号请登录绑定",
		"bt_ssl_help_3":"免费SSL申请的是TrustAsia DV SSL CA - G5 原价：1900元/1年，官方用户免费！",
		"bt_ssl_help_4":"一年满期后免费颁发。",
		"btapply":"申请",
		"endtime":"到期时间",
		"status":"状态",
		"bt_ssl_help_5":"申请之前，请确保域名已解析，如未解析会导致审核失败",
		"bt_ssl_help_6":"免费SSL申请的是免费版TrustAsia DV SSL CA - G5证书，仅支持单个域名申请",
